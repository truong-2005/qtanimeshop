  ...
  return (
    <footer className="bg-white border-t border-slate-200 text-slate-600 select-none py-12 px-6 md:px-16 text-sm">
        ...
        <div className="flex flex-col gap-4">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="font-extrabold tracking-wider text-slate-900">
              ANIME<span className="text-purple-600">STORE</span>
            </span>
          </Link>
          <p className="text-xs text-slate-600 leading-relaxed font-light">
            Cửa hàng phân phối mô hình nhân vật anime, manga bản quyền Nhật Bản chính hãng. Hợp tác chính thức với các studio hàng đầu.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <ul className="flex flex-col gap-2 text-xs font-light">
            <li className="flex items-center gap-2">
              ...
              <span>Hotline: 091 234 5678</span>
            </li>
            <li className="flex items-center gap-2">
              <svg className="w-4 h-4 text-purple-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <span>Email: support@animestore.vn</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto pt-6 border-t border-slate-200 text-center text-xs text-slate-500 flex flex-col sm:flex-row justify-between items-center gap-3">
        <p>© 2026 Anime Store. Hàng chính hãng 100%.</p>
